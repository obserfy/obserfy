/* eslint-disable */
/**
 * This file is copied from gatsby's .cache folder. It contains fragments
 * to be used with gatsby-image. It's easier to have it always available here
 * than to reference the one on the
 */
