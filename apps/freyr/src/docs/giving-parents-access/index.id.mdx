...
To get access to _Parent's Dashboards_ they will first need to sign up for an account using an email that they own by
following the steps below.

#### Steps (for parents/guardians):

1. Open the _Parent's Dashboards_. For example, by clicking **Sign In for Parents** on [obserfy.com](https://obserfy.com) or opening
   [parent.obserfy.com](https://parent.obserfy.com) directly.
2. Click **Sign up**
