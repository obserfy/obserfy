...
1. From the teacher's dashboard, open **Admin** and then click **Invite your Team**.
...
1. From the teacher's dashboard, open **Admin** and then click **Users**.
