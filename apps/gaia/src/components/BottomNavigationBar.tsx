...
const BottomNavigationBar = () => {
  ...
  return (
    <nav className="flex sm:hidden fixed right-0 bottom-0 left-0 flex-col justify-end h-bottom-navigation bg-gradient-to-t from-white pointer-events-none via-[rgba(255,255,255,1)]">
