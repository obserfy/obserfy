...
var themeUiTheme = {
    ...
    fonts: {
        ...
        heading: "Open Sans,-apple-system,BlinkMacSystemFont,San Francisco,Roboto,Segoe UI,Helvetica Neue,sans-serif ",
    },
...
var rebassVariants = {
    ...
    variants: {
        ...
        card: {
            ...
            boxShadow: "rgba(0, 0, 0, 0.1) 0px 0px 1px, rgba(0, 0, 0, 0.27) 0px 2px 4px -2px",
        },
        link: {
            color: "primary",
        },
...
var Theme = __assign(__assign({}, themeUiTheme), rebassVariants);
