...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "e2e",
        "reference": "workspace:apps/e2e"
      },
      {
        "name": "freyr",
        "reference": "workspace:apps/freyr"
      },
      {
        "name": "gaia",
        "reference": "workspace:apps/gaia"
      },
      {
        "name": "vor",
        "reference": "workspace:apps/vor/frontend"
      },
      {
        "name": "gatsby-theme-i18n-lingui",
        "reference": "workspace:packages/gatsby-theme-i18n-lingui"
      }
    ],
    ...
    "fallbackExclusionList": [
      ...
      ["vor", ["workspace:apps/vor/frontend"]]
    ],
    "fallbackPool": [
      [
        "e2e",
      ...
      [
        ...
        "workspace:packages/gatsby-theme-i18n-lingui"
      ],
      [
        "vor",
        "workspace:apps/vor/frontend"
      ]
    ],
    ...
    "packageRegistryData": [
      ...
      ["vor", [
        ["workspace:apps/vor/frontend", {
          "packageLocation": "./apps/vor/frontend/",
          "packageDependencies": [
            ["vor", "workspace:apps/vor/frontend"]
          ],
          "linkType": "SOFT",
